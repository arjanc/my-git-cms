...
export default async function AdminPage({ blockSchemas, pageSchemas, contentBase, settingsPath, } = {}) {
    ...
    const resolvedSettingsPath = resolveContentPath(contentBase, settingsPath ?? 'content/settings.json');
