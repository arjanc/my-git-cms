...
export function ImageField({ field, value, onChange }) {
    ...
    return (React.createElement("div", { className: "space-y-2" },
        React.createElement("div", { className: "flex flex-col gap-2" }, value ? (React.createElement("div", { className: "relative aspect-video w-full max-w-sm rounded border bg-gray-50 overflow-hidden group" },
            ...
            React.createElement("div", { className: "absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity flex-col gap-2" },
                ...
                React.createElement("div", { className: "flex gap-2" },
                    React.createElement("button", { onClick: () => setIsModalOpen(true), className: "p-1.5 bg-blue-600 text-white rounded hover:bg-blue-700 text-xs px-3" }, "Change"),
                    React.createElement("button", { onClick: () => onChange(''), className: "p-1.5 bg-red-600 text-white rounded hover:bg-red-700", title: "Remove image" },
                        React.createElement("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" },
                            React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }))))))) : (React.createElement("button", { onClick: () => setIsModalOpen(true), className: "w-full max-w-sm aspect-video border-2 border-dashed border-gray-300 rounded flex flex-col items-center justify-center text-gray-400 hover:border-blue-400 hover:text-blue-500 transition-colors" },
